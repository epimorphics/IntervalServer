...
public class HourDoc extends Doc {
	...
	protected static Resource createResource(URI base, Model m, int year, int moy, int dom, int hod) {
		...
		m.add(r_hour, SCOVO.min, formatScvDate(cal, iso8601dateTimeformat, XSDDatatype.XSDdateTime) );
		...
		m.add(r_hour, SCOVO.max, formatScvDate(cal, iso8601dateTimeformat, XSDDatatype.XSDdateTime) );
