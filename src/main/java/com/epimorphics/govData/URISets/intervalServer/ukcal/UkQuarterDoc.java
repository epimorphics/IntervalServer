...
@Path(UkCalURITemplate.DOC_STEM+UkCalURITemplate.QUARTER_SEGMENT+UkCalURITemplate.SET_EXT_PATTERN)
public class UkQuarterDoc extends UkDoc {
	...
	void addContainingIntervals() {
		...
		Resource r_thisHalf = UkHalfDoc.createResourceAndLabels(base, model, year, half);
