...
@Path(UkCalURITemplate.DOC_STEM+UkCalURITemplate.DAY_SEGMENT+UkCalURITemplate.SET_EXT_PATTERN)
public class UkDayDoc extends UkDoc {
	...
	void addContainedIntervals() {
		...
		for (int hour = i_min_hid; hour <= i_max_hid; hour++) {
			Resource r_hour = UkHourDoc.createResourceAndLabels(base, model, year, month, day, hour);
