...
@Path(UkCalURITemplate.DOC_STEM+UkCalURITemplate.SECOND_SEGMENT+UkCalURITemplate.SET_EXT_PATTERN)
public class UkSecDoc extends UkDoc {
	...
	void addContainingIntervals() {
		...
		Resource r_thisMin     = UkMinuteDoc.createResourceAndLabels(base, model, year, month, day, hour, min);
